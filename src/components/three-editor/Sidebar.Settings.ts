// @ts-nocheck
import { UIPanel, UIRow, UISelect, UISpan, UIText } from "./libs/ui"

import { SidebarSettingsShortcuts } from "./Sidebar.Settings.Shortcuts"
import { SidebarSettingsHistory } from "./Sidebar.Settings.History"
...
function SidebarSettings(editor) {
  ...
  languageRow.add(
    new UIText(strings.getKey("sidebar/settings/language")).setClass("Label")
  )
