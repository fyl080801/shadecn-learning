...
function Strings(config) {
  ...
  const values = {
    fa: {
      ...
      "prompt/file/export/duplicateNames":
        "Some objects share the same name. They will be renamed to ensure unique names. Are you sure?",
    ...
    fr: {
      ...
      "prompt/file/export/duplicateNames":
        "Certains objets portent le même nom. Ils seront renommés afin de garantir des noms uniques. Êtes-vous sûr ?",
    ...
    zh: {
      ...
      "prompt/file/export/duplicateNames":
        "部分对象具有相同的名称。它们将被重命名以确保名称唯一。确定吗？",
    ...
    ja: {
      ...
      "prompt/file/export/noObjectSelected":
        "オブジェクトが選択されていません!",
      "prompt/file/export/duplicateNames":
        "一部のオブジェクトの名前が重複しています。名前を一意にするために変更します。よろしいですか？",
    ...
    ko: {
      ...
      "prompt/file/export/duplicateNames":
        "일부 객체의 이름이 중복됩니다. 이름을 고유하게 만들기 위해 변경됩니다. 계속하시겠습니까?",
