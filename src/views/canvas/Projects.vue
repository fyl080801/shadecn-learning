 ...
 *
 * **这一页只列项目**。个人画布是另一个侧栏入口、另一个页面
 * （`PersonalFlows.vue`）：两者是两种东西，不是一个列表的两个筛选项，
 * 混在同一页的 Tab 里只会让「当前在看哪一种」变成一个要先想一下的问题。
 */
...
<template>
  <div class="mx-auto flex h-full w-full max-w-6xl flex-col gap-6 p-6">
    <header>
      <h1 class="text-2xl font-semibold tracking-tight">画布项目</h1>
      <p class="text-sm text-muted-foreground">
        项目里的画布多人实时协作；只有自己用的画布去侧栏的「个人画布」。
      </p>
    </header>
