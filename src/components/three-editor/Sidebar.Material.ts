...
function SidebarMaterial(editor) {
  ...
  materialClassRow.add(
    new UIText(strings.getKey("sidebar/material/type")).setClass("Label")
  )
  ...
  materialUUIDRow.add(
    new UIText(strings.getKey("sidebar/material/uuid")).setClass("Label")
  )
  ...
  materialNameRow.add(
    new UIText(strings.getKey("sidebar/material/name")).setClass("Label")
  )
  ...
  exportJson.onClick(function () {
    ...
    editor.utils.save(
      new Blob([output]),
      `${materialName.getValue() || "material"}.json`
    )
  })
    ...
    if (material) {
      ...
      if (material.type !== materialClass.getValue()) {
        ...
        editor.execute(
          ...
          strings.getKey("command/SetMaterial") +
            ": " +
