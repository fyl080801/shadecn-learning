...
import { UIRow, UIButton, UIInteger, UISelect, UIText } from "./libs/ui"
...
class RenderImageDialog {
  constructor(editor, strings) {
    ...
    titleBar.textContent =
      ...
      " " +
      strings.getKey("menubar/render/image")
    ...
    shadingRow.add(
      new UIText(strings.getKey("sidebar/project/shading")).setClass("Label")
    )
    ...
    const samplesNumber = new UIInteger(16).setRange(
    ...
    const imageWidth = new UIInteger(1024)
      .setTextAlign("center")
      .setWidth("28px")
    ...
    const imageHeight = new UIInteger(1024)
      .setTextAlign("center")
      .setWidth("28px")
    ...
    renderButton.onClick(async () => {
      if (shadingTypeSelect.getValue() === "realistic") {
        ...
        if (isMaterialsValid === false) {
          alert(
            strings.getKey("prompt/rendering/realistic/unsupportedMaterial")
          )
          return
        }
      }
...
class RenderVideoDialog {
  constructor(editor, strings) {
    ...
    titleBar.textContent =
      strings.getKey("menubar/render") +
      " " +
      strings.getKey("menubar/render/video")
    content.appendChild(titleBar)
    ...
    qualityRow.add(
      new UIText(strings.getKey("menubar/render/quality")).setClass("Label")
    )
