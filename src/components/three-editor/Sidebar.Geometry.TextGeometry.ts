...
function GeometryParametersPanel(editor, object) {
  ...
  textRow.add(
    new UIText(strings.getKey("sidebar/geometry/text_geometry/text")).setClass(
      "Label"
    )
  )
  textRow.add(text)
  ...
  const size = new UINumber()
    .setPrecision(3)
    .setValue(parameters.size)
    .onChange(update)

  sizeRow.add(
    new UIText(strings.getKey("sidebar/geometry/text_geometry/size")).setClass(
      "Label"
    )
  )
  sizeRow.add(size)
  ...
  const depth = new UINumber()
    .setPrecision(3)
    .setValue(parameters.depth)
    .onChange(update)

  depthRow.add(
    new UIText(strings.getKey("sidebar/geometry/text_geometry/depth")).setClass(
      "Label"
    )
  )
  depthRow.add(depth)
  ...
  const curveSegments = new UIInteger(parameters.curveSegments)
    .setRange(1, Infinity)
    .onChange(update)

  curveSegmentsRow.add(
    new UIText(
      strings.getKey("sidebar/geometry/text_geometry/curveseg")
    ).setClass("Label")
  )
  ...
  bevelEnabledRow.add(
    new UIText(
      strings.getKey("sidebar/geometry/text_geometry/bevelenabled")
    ).setClass("Label")
  )
  ...
  const bevelThickness = new UINumber(parameters.bevelThickness)
    .setPrecision(3)
    .setRange(0, Infinity)
    .onChange(update)

  bevelThicknessRow.add(
    new UIText(
      strings.getKey("sidebar/geometry/text_geometry/bevelthickness")
    ).setClass("Label")
  )
  ...
  const bevelSize = new UINumber(parameters.bevelSize)
    .setRange(0, Infinity)
    .onChange(update)
  ...
  const bevelOffset = new UINumber(parameters.bevelOffset)
    .setRange(0, Infinity)
    .onChange(update)

  bevelOffsetRow.add(
    new UIText(
      strings.getKey("sidebar/geometry/text_geometry/bevelOffset")
    ).setClass("Label")
  )
  ...
  const bevelSegments = new UIInteger(parameters.bevelSegments)
    .setRange(0, Infinity)
    .onChange(update)

  bevelSegmentsRow.add(
    new UIText(
      strings.getKey("sidebar/geometry/text_geometry/bevelseg")
    ).setClass("Label")
  )
